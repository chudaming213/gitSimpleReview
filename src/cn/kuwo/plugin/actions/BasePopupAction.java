...
public abstract class BasePopupAction extends DumbAwareAction implements CustomComponentAction {
    ...
    protected JTextArea selectUserTextArea;
    protected JBPopup popup;
    protected AnAction selectOkAction;
    ...
    protected static final String POPUP_TEXT = String.format("%s to search",
            KeymapUtil.getShortcutsText(CommonShortcuts.CTRL_ENTER.getShortcuts()));

    protected JBPopup buildBalloon(JTextArea textArea) {
        PopupFactoryImpl jbPopupFactory = new PopupFactoryImpl();
